...
<section id="host" className="section4">
          ...
          <h1 className="sectionHeadings font-bold mb-2">Meet Your <span className='text-white'>Host</span></h1>
          <p className="text-justify text-white mr-10 ml-10 text-gray-700 pr-14 pl-14 mb-8">
